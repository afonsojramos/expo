...
- Add `album.getAllMetadata()` for cheap bulk album listing and `album.getAssetCount()`. ([#47836](https://github.com/expo/expo/pull/47836) by [@Wenszel](https://github.com/Wenszel))
